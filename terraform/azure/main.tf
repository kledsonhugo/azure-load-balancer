...
resource "azurerm_application_gateway_backend_address_pool_address" "vm01" {
  application_gateway_name = azurerm_application_gateway.appgw.name
  resource_group_name      = azurerm_resource_group.rg.name
  backend_address_pool_name = "backendPool"
  ip_address               = azurerm_network_interface.vm01-nic.private_ip_address
}

resource "azurerm_application_gateway_backend_address_pool_address" "vm02" {
  application_gateway_name = azurerm_application_gateway.appgw.name
  resource_group_name      = azurerm_resource_group.rg.name
  backend_address_pool_name = "backendPool"
  ip_address               = azurerm_network_interface.vm02-nic.private_ip_address
}